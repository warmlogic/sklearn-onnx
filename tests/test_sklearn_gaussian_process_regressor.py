...
class TestSklearnGaussianProcessRegressor(unittest.TestCase):
            ...
            for i, (e, g) in enumerate(zip(exp, got)):
                ...
                try:
                    ...
                    raise AssertionError(
                        "Mismatch for output {} and attributes {}.".format(
                            i, predict_attributes
                        )
                    ) from e
        else:
    ...
    def test_gpr_rbf_fitted_return_std_exp_sine_squared_false(self):
        ...
        dump_data_and_model(
            ...
            # operator MatMul gets replaced by FusedMatMul but onnxruntime does
            # not check the availability of the kernel for double.
            disable_optimisation=True,
        )
        self.check_outputs(
            gp,
